				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom"><img width="400" jqimg="${imageList[0].url}" src="${imageList[0].url}" /></span>
						</div>
						<!--下方的缩略图-->
							...
							<div class="items">
								<ul>
									<#list imageList as img>
										<li><img src="${img.url}" width="60" height="100" bimg="${img.url}" onmousemove="preview(this)" /></li>
									</#list>
							...
							<#list specificationItems as spec>
								<dl>
									...
									<#list spec.attributeValue as value>
										<dd>
											<a href="javascript:;"
											   class="{{isSelected('${spec.attributeName}','${value}')==true ? 'selected':''}}"
											   ng-click="selectItem('${spec.attributeName}','${value}')">${value}
